...
WebUI.setText(findTestObject('Object Repository/souceDemo/Page_Swag Labs/input_Swag Labs_user-name'), userName)
WebUI.setText(findTestObject('Object Repository/souceDemo/Page_Swag Labs/input_Swag Labs_password'), password)

WebUI.click(findTestObject('Object Repository/souceDemo/Page_Swag Labs/input_Epic sadface Username is required_login-button'))
